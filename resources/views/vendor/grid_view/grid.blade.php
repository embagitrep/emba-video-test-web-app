                        ...
                        <td colspan="{{ count($columnObjects) + 1 }}">
                            <div class="mx-1">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-lg-4 text-center text-lg-right" style="display: flex; align-items: center">
                                        @if ($useFilters)
                                            <button id="grid_view_search_button" type="button" class="btn btn-primary" style="margin-right: 10px">{{ $searchButtonLabel }}</button>
