            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <div class="card-body">
                            <form class="form form-horizontal" action="{{ route('admin.vendor.store') }}" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 form-group">
                                            ...
                                            <input type="text" class="form-control" value="{{ old('process_time') }}" name="process_time" placeholder="Processing time">
                                        </div>

                                        <div class="col-md-4 form-group">
                                            <label>Max installment</label>
                                            <input type="text" class="form-control" value="{{ old('max_installment') }}" name="max_installment" placeholder="Max installment">
                                        </div>
                                        ...
                                        <div class="col-md-4 form-group">
                                            ...
                                            <input type="text" value="{{ old('api_endpoint') }}" class="form-control" name="api_endpoint" placeholder="Base URL">
                                        </div>
                                        <div class="col-md-4 form-group">
                                            <label>Key</label>
