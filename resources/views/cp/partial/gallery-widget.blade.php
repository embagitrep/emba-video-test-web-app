@push('css')
    ...
    <link type="text/css" rel="stylesheet"
          href="{{ url('css/jquery-ui.min.css') }}"
          media="screen"/>
                ...
                init: {
                    'FileUploaded': function (up, file, res) {
                        ...
                        req.fail(function (jqXHR, textStatus) {
                            if (confirm('Error occurred, refresh please')) {
                            }
                ...
                <div class="col-xs-6 col-sm-4 col-md-3 mt10 photo-block">
                    <div class="blog-item sortable" data-sortable="{{ $photo->id }}">
                        ...
                        <div class="blog-details">
                            <ul class="blog-meta">
                                <li><a class="delete-button delete btn btn-danger" href="{{ route('deleteGallery', ['id' => $photo->id]) }}">Delete</a></li>
{{--                                <li class="list-inline-item">--}}
{{--                                    <input data-link="{{route('editGallery', ['id' => $photo->id])}}" type="text" name="position" placeholder="Link" class="form-control js--galleryPosition" value="{{ $photo->position }}">--}}
{{--                                </li>--}}
                            </ul>
                        </div>
