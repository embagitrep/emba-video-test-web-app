            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <div class="card-body">
                            <form class="form form-horizontal" action="{{ route('admin.merchant.update',['merchant' => $model->id]) }}" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 form-group">
                                            ...
                                            <input type="text" value="{{ $model->api_username }}" class="form-control" name="api_username" placeholder="Username">
                                        </div>
                                        <div class="col-md-4 form-group">
                                            <label>Key</label>
                                            <div class="input-group">
                                                <input type="text" value="{{ $model->api_key }}" class="form-control js--apiKey" name="api_key" placeholder="Key">
