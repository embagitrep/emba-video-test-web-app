                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb p-0 mb-0">
                            <li class="breadcrumb-item active">
                                <a href="{{ route('admin.page.items', ['page' => $post->parent_id]) }}">List</a>
                            </li>
                        </ol>
                    </div>
                </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Item edit: {{ $post->name }}</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs nav-fill" id="myTab" role="tablist">
                                ...
                                <li class="nav-item ">
                                    <a class="nav-link " id="{{ $language }}-tab-fill" data-toggle="tab" href="#{{ $language }}-fill" role="tab" aria-controls="{{ $language }}-fill" aria-selected="true">
                                        {{ $language }}
                                    </a>
                                </li>
                                @endforeach
