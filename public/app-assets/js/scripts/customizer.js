...
(function (window, document, $) {
  ...
  $(document).on("click", "#customizer-theme-colors .color-box", function () {
    ...
    // Text with logo
    $(".venue-text").css("color", selectedTextColor);
    // toggle icon
  ...
  function setLayout(currentLayout) {
    if (currentLayout == "system") {
      currentLayout = window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark-layout" : "";
    }
