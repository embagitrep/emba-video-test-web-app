...
(function (window, document, $) {
  ...
  $.app.menu = {
    ...
    change: function (defMenu, menuIconColorsObj) {
      ...
      // Added data attribute venue-center for navbar-venue-center
      // TODO:AJ: Shift this feature in JADE.
      if ($('.header-navbar').hasClass('navbar-brand-center')) {
        $('.header-navbar').attr('data-nav', 'venue-center');
      }
      if (currentBreakpoint.name == 'sm' || currentBreakpoint.name == 'xs') {
        $('.header-navbar[data-nav=venue-center]').removeClass('navbar-brand-center');
      } else {
        $('.header-navbar[data-nav=venue-center]').addClass('navbar-brand-center');
      }
