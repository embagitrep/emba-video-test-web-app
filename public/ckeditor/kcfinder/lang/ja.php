...
$lang = [
    ...
    'Cannot fetch content of {dir} folder.' => '{dir} フォルダのコンテンツを読み込めません。',
    ...
    'Unallowed characters in folder name.' => 'フォルダ名には利用できない文字です。',

    "Folder name shouldn't begins with '.'" => "フォルダ名は、'.'で開始しないで下さい。",

    'Please enter new file name.' => '新しいファイル名を入力して下さい。',

    'Unallowed characters in file name.' => 'ファイル名には利用できない文字です。',
    ...
    'Unexisting directory type.' => '存在しないディレクトリの種類です。',
