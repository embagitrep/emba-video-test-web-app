...
$lang = [
    ...
    "File name shouldn't begins with '.'" => "Το όνομα του αρχείου δε πρέπει να αρχίζει με '.'",
    ...
    'Fileinfo PECL extension is missing.' => 'Η πληροφορία αρχείου επέκταση PECL δεν υπάρχει.',
    ...
    'Click to remove from the Clipboard' => 'Πατήστε για  διαγραφή από το Clipboard.',

    'This file is already added to the Clipboard.' => 'Αυτό το αρχείο βρίσκεται ήδη στο Clipboard.',
    ...
    'Are you sure you want to delete all files in the Clipboard?' => 'Σίγουρα θέλετε να διαγράψετε όλα τα αρχεία στο Clipboard?',

    'Copy {count} files' => 'Αντιγραφή  {count} αρχείων.',

    'Move {count} files' => 'Μετακίνηση {count} αρχείων.',

    'Add to Clipboard' => 'Προσθήκη στο Clipboard',
    ...
    'The files in the Clipboard are not readable.' => 'Τα αρχεία στο Clipboard είναι μη αναγνώσιμα.',

    '{count} files in the Clipboard are not readable. Do you want to copy the rest?' => '{count} αρχεία στο Clipboard είναι μη αναγώσιμα.Θέλετε να αντιγράψετε τα υπόλοιπα?',

    'The files in the Clipboard are not movable.' => 'Τα αρχεία στο Clipboard είναι αδύνατο να μετακινηθούν.',

    '{count} files in the Clipboard are not movable. Do you want to move the rest?' => '{count} αρχεία στο Clipboard δεν είναι δυνατό να μετακινηθούν.Θέλετε να μετακινήσετε τα υπόλοιπα?',

    'The files in the Clipboard are not removable.' => 'Τα αρχεία στο Clipboard είναι αδύνατο να αφαιρεθούν.',

    '{count} files in the Clipboard are not removable. Do you want to delete the rest?' => '{count} αρχεία στο Clipboard δεν είναι δυνατό να αφαιρεθούν.Θέλετε να αφαιρέσετε τα υπόλοιπα?',
