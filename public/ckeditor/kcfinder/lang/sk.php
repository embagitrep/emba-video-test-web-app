...
$lang = [
    ...
    "You don't have permissions to browse server." => 'Nemáte právo prehliadať súbory na servery.',

    'Cannot move uploaded file to target folder.' => 'Nie je možné presunúť súbor do yvoleného adresára.',
    ...
    'No file was uploaded.' => 'Žiadný súbor alebol nahraný na server.',

    'Missing a temporary folder.' => 'Chyba dočasný adresár.',

    'Failed to write file.' => 'Súbor se nepodarilo se uložiť.',
    ...
    'Cannot write to upload folder.' => 'Nie je možné ukladať do adresáru pre nahrávánie.',
    ...
    'Cannot read upload folder.' => 'Nie je možné čítať z adresáru pre nahrávánie súborov.',

    'Cannot access or create thumbnails folder.' => 'Adresár pre náhľady nie je možné vytvoriť alebo nie je prístupný.',

    'Cannot access or write to upload folder.' => 'Nie je možné pristupova alebo zapisovať do adresáru pre nahrávanie súborov.',

    'Please enter new folder name.' => 'Zadajte prosím nové meno adresáru.',

    'Unallowable characters in folder name.' => 'Nepovolené znaky v názve adresáru.',
    ...
    'The selected files are not removable.' => 'Označené súbory nie je možné vymazať.',

    '{count} selected files are not removable. Do you want to delete the rest?' => '{count} označených súborov nie je možné vymazať. Chcete vymazať ostatné súbory?',
